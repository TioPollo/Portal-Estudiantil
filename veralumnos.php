...
<body>
	...
	<div class="container">
		<div id="titulo">
			<label id="h11">Ver Alumnos</label>
		</div>
		<div id="mid">
			<div id="mid2">
				<div class="block">
					<form action="veralumnos2.php" method="POST">
						<select class="inputs" name="tipo" id="Tipo" required>
						...
						<input type="submit" id="btn2" value="Ver">
					</form>
				</div>
			</div>
		</div>
