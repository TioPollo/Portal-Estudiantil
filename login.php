...
<html lang="en">
 ...
 <body>
	...
	<form id="form1">
 		<input type="text" placeholder="Rut"  name="rut" id="t1" required>
 		<input type="password" placeholder="Contraseña" name="pass" id="t2" required>
 		<input id="btn1" type="button" name="btn1" Value="Iniciar Sesión" onclick="javascript:enviarDatos()">
 		<label id="lbl1"></label>
 	</form>
